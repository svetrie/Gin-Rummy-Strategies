...
public class CautiousPlayerStrategy implements PlayerStrategy {

    private static final int CARDS_PER_SUIT = 13;
    private static final int MIN_CARDS_PER_MELD = 3;
    private static final int MAX_DEADWOOD_TOTAL_TO_KNOCK = 0;
    ...
    private CautiousPlayerStrategy opponent;


    public void loadOpponent() {
        opponent = new CautiousPlayerStrategy();
    }
